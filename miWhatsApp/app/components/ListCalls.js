   ...
   return(
      <View style = {styles.listItemContainer}>
          ...
          <View style = {styles.chatDetailsContainer}>
              ...
              <View style={styles.chatDetailsContainerWrap}>
              <Icon name= {this.props.missed ? "call-received" : "call-missed" } 
              color={this.props.missed ? "#075e54" : "#DB0000" } 
              size={18} style={{padding:2}} />         
          ...
          <View style= {styles.end}>
              <Icon name={this.props.video_call ? "videocam" : "call"} 
                  size={30} 
                  color="green" style={{padding:5}} 
              />
          </View>        
      </View> 
   )
