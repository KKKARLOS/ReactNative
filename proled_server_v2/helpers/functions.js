...
exports.createPlayer = (oGoogleData) => {
	let player = new Player();
	player.email = oGoogleData.email;
	player.photo = oGoogleData.photo;
	player.name = oGoogleData.name;
	player.nickname = oGoogleData.nickname;
	player.country = oGoogleData.country;
	player.birthday = oGoogleData.birthday;
	player.phone = oGoogleData.phone;
